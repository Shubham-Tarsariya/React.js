    ...
    <>
      <section className="px-10 overflow-x-auto w-[80%] mx-auto">
        ...
        <div className="flex flex-col justify-between my-6">
            <h3 className="text-lg font-normal">Todays Deal</h3>
            <div className="my-6 flex items-center justify-between">
              <h1 className="font-semibold text-3xl">Deals of the Day</h1>
              <p className="text-md text-gray-400">Lorem ipsum dolor sit amet consectetur adipisicing elit. Excepturi, aliquam!
                <br />
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Deserunt, quidem placeat!
              </p>
            </div>
        </div>
