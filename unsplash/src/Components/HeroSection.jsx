import { Search, Focus, CircleCheck } from "lucide-react";
    ...
    <>
      <section className="flex items-end justify-center gap-10 w-full">
        ...
        <div className="w-1/2">
          ...
          <div className="bg-gray-200 my-4 px-3 py-3 flex items-center justify-between gap-x-2 rounded-full">
        ...
        {/* card */}
        <div className="border border-black/20 rounded-md  flex items-center justify-center px-4 py-6 w-1/2 max-w-xl">
          {/* text */}
          <div className="w-1/2 flex flex-col items-start justify-end gap-y-25">
            <div>
                <svg
              width="24"
              height="24"
            ...
            <p className="mt-2 font-semibold text-lg leading-5 text-gray-500">
              Premium downloads
              <br />
            ...
            <button className=" bg-black text-white py-1 px-3 rounded-lg font-medium">
              Get Unsplash+
            </button>
          </div>
          ...
          <div className="w-1/2">
            <div className="relative">
              <img
                ...
                className="-rotate-6"
              />
              <img src="https://unsplash-assets.imgix.net/modules/legal-protections/photo-2.jpg?w=192&dpr=1&h=257&auto=format&fit=crop&q=60" alt="img"
              className="absolute top-0 left-8 rotate-10" />

              <div className="flex items-center justify-center text-[12px] gap-2 bg-white z-10 absolute px-2 py-1 rounded-full font-medium top-32 left-20 border border-gray-300"><CircleCheck fill="green" className="text-white w-4 h-4 "/>
                Worry-free Licensing
              </div>
              <div className="flex items-center justify-center text-[12px] gap-2 bg-white z-10 absolute px-2 py-1 rounded-full font-medium border border-gray-300 top-44 -left-5"><CircleCheck fill="green" className="text-white w-4 h-4 "/>
                Cleared for all uses
              </div>
              
              {/* Signature */}
              <div className="w-48 absolute -bottom-6 right-10">
                <svg
