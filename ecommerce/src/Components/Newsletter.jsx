    ...
    return (
        <>
            <section className='flex flex-col items-center justify-center text-center'>
                ...
                <p className='text-gray-500 py-4'>Get 20% off on your first order just by subscribing to our newsletter</p>
                ...
                <div className='flex items-center justify-center gap-2 py-10'>
                    <div className='flex items-center gap-x-4 border border-gray-200 p-1.5 w-150'>
                        ...
                        <input type="text" placeholder='Enter Email Address' className='w-full outline-none text-lg'/>
                    </div>

                    <button className='bg-[#582f0e] text-white px-8 py-5 font-medium text-xl'>Subscribe</button>
                </div>
            </section>
        </>
    )
