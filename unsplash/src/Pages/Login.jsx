    ...
    return (
        <>
            <section className="flex items-center justify-center flex-col mt-20">
                ...
                <p className="text-[15px] font-normal">Welcome back.</p>
                <form 
                    className="w-[30%] "
                    onSubmit={(e) => {
                        e.preventDefault();
                    ...
                    {/* Email */}
                    <div className="my-6">
                        <label htmlFor="Email" className="text-[15px] font-normal mb-2">
                            Email
                        </label>
                        <input
                    ...
                    <div className="my-6">
                        <div className="flex justify-between items-center py-1">
                            ...
                            <a className="text-[#767676] font-normal underline decoration-1 hover:text-black">
                    ...
                    <input className="w-full bg-black text-white py-2 px-4 rounded-md text-[15px] font-normal"
                        type="submit"
                        value="Login"
                    />
                </form>
                 ...
                 <div className="w-150 border border-gray-300 p-6 my-6 text-center h-26 flex items-center justify-center relative">
                    ...
                    <p>
                        Dont't Have an Account? <a href="">Join</a>
                    </p>
                    <svg
                        ...
                        xmlns="http://www.w3.org/2000/svg"><g>
                            <path d="M13.81 47.388c-2.05-.767-4.005-1.768-5.967-2.716a64.79 64.79 0 0 0-4.025-1.792c-.063-.025-1.036-.312-.998-.456.081-.313.512-.654.71-.877 1.072-1.197 2.106-2.416 3.004-3.744 1.273-1.882 2.492-4.036 2.763-6.3"></path><path d="M3 42.42c15.225-3.279 28.41-9.747 36.76-23.393C46.038 8.767 50.728-3.093 52.217-15"></path></g>
                    </svg>
                </div>
            </section>
        </>
