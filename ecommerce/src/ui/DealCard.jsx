...
const DealCard = ({ productData }) => {
  ...
  return (
    <div className="w-lg bg-white rounded-xl shadow-md p-4 flex gap-4 hover:shadow-lg transition duration-300 border border-gray-300">
      {/* Image Section */}
      ...
      <div className="flex flex-col justify-between flex-1">
        ...
        <div>
          ...
          <h2 className="text-lg font-semibold mt-1">{productData.title.length > 16 ? productData.title.slice(0, 16) + "..." : productData.title}</h2>
          ...
          <p className="text-sm text-gray-500 mt-2">
            {productData.description.length > 10 ? productData.description.slice(0, 50) + '...' : productData.description}
          </p>
        </div>
